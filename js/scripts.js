...
var pokemonRepository = (function() {
  ...
  function addListItem(pokemon) {
    ...
    var button = $(
      '<button type="button" class="btn btn-outline-dark btn-sm btn-block list-group-item" data-target="#exampleModal" data-toggle="modal"></button>'
    );
